...
import java.text.*;
import java.util.*;
import Internationalization.GBC;
import javax.swing.*;
...
class RetireFrame extends JFrame
{
   ...
   public void setCurrentLocale(Locale locale)
   {
      ...
      res = ResourceBundle.getBundle("Internationalization.retire.RetireResources", currentLocale);
      resStrings = ResourceBundle.getBundle("Internationalization.retire.RetireStrings", currentLocale);
