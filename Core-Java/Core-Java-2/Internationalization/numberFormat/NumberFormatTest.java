...
class NumberFormatFrame extends JFrame
{
    ...
    private JRadioButton percenRadioButton = new JRadioButton("Percent");
    ...
    public NumberFormatFrame()
    {
        ...
        addRadioButton(p, percenRadioButton, rbGroup, listener);
    ...
    public void updateDisplay()
    {
        ...
        else if (percenRadioButton.isSelected())
